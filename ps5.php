    ...
    <a href="index.php"><img src="image/logo1.png" id="logo"></a>
        <span id="form">
            <form >
                ...
                <br>
                <a href="registration.html"><button type="button" id="btn2"> Register<img src="image/arrow.png"></button></a>  
        ...
        <tr>
          <td style="padding-top: 100px;">
              <div class="card" style="width: 20rem; margin-left: 10px;">
               <img src="image/playstation-5-horizontal-product-shot-01-ps5-en-23nov20.png" class="card-img-top" alt="..." style="width: 80%;">
               <div class="card-body">
            ...
            <td>
              <div id="ps5">
                <h2>PlayStation 5</h2>
                <h6>Your Journey Begins Here.</h6>
              <p>Experience lightning-fast loading with an ultra-high speed SSD, deeper immersion with support for haptic feedback1, adaptive triggers1 and 3D Audio*, and an all-new generation of incredible PlayStation games.

                *3D Audio with compatible headphones</p>
