...
<head>
    ...
    <title>PlayStation VR | PS5</title>
      ...
      <table>
        <tr>
          <td style="padding-top: 100px;">
              <div class="card" style="width: 20rem; height: 340px; margin-left: 10px;">
               <img src="image/vr.png" class="card-img-top" alt="..." style="width: 116%;"><br><br>
               <div class="card-body">
            ...
            <td>
              <div id="ps5">
                ...
                <h6>Immerse yourself in incredible virtual reality games and experiences.</h6>
                <p>The fully immersive PS VR headset
                    360-degree vision
                    Watch as a living, breathing game world comes alive all around you, with a seamless field of view wherever you turn.
                    
                    Stunning visuals
                    Experience new realities with a custom OLED screen and smooth 120fps visuals to create complete immersion in your games.</p>
