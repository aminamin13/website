...
<head>
    ...
    <title>Wirless Controller | PS5</title>
        ...
        <tr>
          <td style="padding-top: 100px;">
              <div class="card" style="width: 20rem; margin-left: 10px;">
               <img src="image/QK67M.jpg" class="card-img-top" alt="..." style="width: 65%;">
               <div class="card-body">
            ...
            <td>
              <div id="ps5">
                ...
                <h6>Heighten Your Senses™</h6>
                <p>The DualSense wireless controller for PS5 offers immersive haptic feedback2, dynamic adaptive triggers2 and a built-in microphone, all integrated into an iconic design.</p>
