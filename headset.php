...
<head>
    ...
    <title>Wireless Headset | PS5</title>
        ...
        <tr>
          <td style="padding-top: 100px;">
              <div class="card" style="width: 20rem; margin-left: 10px;">
               <img src="image/hed.jpg" class="card-img-top" alt="..." style="width: 80%;">
               <div class="card-body">
            ...
            <td>
              <div id="ps5">
                ...
                <h6>How Games Were Made to Sound™</h6>
                <p>Enjoy a seamless, wireless experience with a headset fine-tuned for 3D Audio on PS5 consoles.1 The PULSE 3D wireless headset features a refined design with dual noise-cancelling microphones, USB Type-C® charging, and an array of easy-access controls.</p>
