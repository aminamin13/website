...
<body>
  <a href="index.php"><img src="image/logo1.png" style="width: 10%; "></a>

    <div class="login-box">
    <br><br><br><br>
        <h2 style="color: rgb(10, 50, 233)">Registration To PS World</h2>
        <form name="registration" method ="POST" onsubmit="return validation()" action="save.php">
          <div class="user-box">
          ...
          <div class="user-box">
            ...
            <div class="user-box">
                <input type="text" required name="nationalty">
                <label>Nationalty</label>
            </div>    
            <div class="user-box">
                <input type="date" required name="dob">
                <label id="dob">Date Of Birthday</label> 
                </div>      
          <button type="submit">
            <span></span>
            <span></span>
